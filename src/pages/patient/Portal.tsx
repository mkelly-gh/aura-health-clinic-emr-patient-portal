    ...
    <div className="min-h-screen bg-sky-50/50 dark:bg-background font-sans">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
             ...
             <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-sky-500 to-teal-400 border-2 border-white shadow-md flex items-center justify-center font-bold text-white">
               {patient?.firstName?.[0] || 'U'}{patient?.lastName?.[0] || 'P'}
             </div>
          </div>
        </div>
      </header>
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-gradient-to-br from-sky-600 via-sky-700 to-teal-700 rounded-3xl p-6 sm:p-10 text-white shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <Badge className="bg-white/20 hover:bg-white/30 text-white border-none mb-4">Clinical Update: Today</Badge>
                <h1 className="text-3xl sm:text-5xl font-bold mb-4">Health Status: Optimal</h1>
                <p className="text-sky-100 text-lg max-w-md leading-relaxed">Your vitals are stable. Dr. Aura has prepared your health summary based on recent records.</p>
              ...
              <Card className="rounded-3xl border-none shadow-soft hover:shadow-lg transition-all overflow-hidden bg-white dark:bg-card">
                ...
                <CardContent className="pt-6 space-y-6">
                  <div className="space-y-1">
                     ...
                     <div className="font-bold text-xl text-foreground">{patient?.diagnoses[0]?.description || 'No diagnoses on record'}</div>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4 p-4 border rounded-2xl hover:bg-muted/30 transition-colors cursor-pointer group">
                   ...
                   <div>
                     ...
                     <div className="text-xs text-muted-foreground font-medium">Virtual Consultation • 10:30 AM</div>
                   </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="fixed bottom-8 right-8 z-[60] flex flex-col items-end gap-4">
            ...
            {!chatOpen && (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Hi {patient?.firstName}! I've synced with your chart. Have any questions about your medications or results?
                </p>
          ...
          <Button
            ...
            className={`rounded-full h-16 w-16 shadow-2xl transition-all duration-300 ${chatOpen ? 'bg-destructive hover:bg-destructive/90 shadow-destructive/20 rotate-90' : 'bg-sky-600 hover:bg-sky-700 shadow-sky-600/40 active:scale-90'}`}
          >
      ...
      <footer className="mt-12 py-12 border-t bg-muted/10">
        <div className="max-w-7xl mx-auto px-4 text-center space-y-4">
          ...
          <p className="text-xs text-muted-foreground">© 2024 Aura Health Clinic. All rights reserved. Secure Gateway v2.5</p>
