...
import { APP_VERSION } from "../../../worker/config";
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Badge variant="clinical-stable" className="h-6 px-2 rounded-none text-[9px] font-black uppercase border-none">v{APP_VERSION}</Badge>
            </div>
          </div>
